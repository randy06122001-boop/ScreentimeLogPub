class ScreenTimeApp {
  ...
  async updateDashboard() {
    ...
    try {
      ...
      if (dailySummary) {
        ...
        document.getElementById('today-time').textContent = '0h 0m';
        document.getElementById('longest-session').textContent = '0h 0m';
      }
  ...
  updatePomodoroUI(state) {
    ...
    statusEl.textContent = statusTexts[state.currentPhase] || 'Ready';
    ...
    // Update stats
    document.getElementById('pomodoro-sessions-today').textContent = state.sessionsCompleted || 0;
